...
import Edit from '@/components/security/role/edit/role-edit-admin.component';
import Create from '@/components/security/role/create/role-create-admin.component';
import View from '@/components/security/role/view/role-view-admin.component';
