...
import Create from '@/components/security/action-permission/create/action-permission-create-admin.component';
import Edit from '@/components/security/action-permission/edit/action-permission-edit-admin.component';
import View from '@/components/security/action-permission/view/action-permission-view-admin.component';
