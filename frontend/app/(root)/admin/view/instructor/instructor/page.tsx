...
import Edit from '@/components/admin/view/instructor/instructor/edit/instructor-edit-admin.component';
import Create from '@/components/admin/view/instructor/instructor/create/instructor-create-admin.component';
import View from '@/components/admin/view/instructor/instructor/view/instructor-view-admin.component';
...
const List = () => {
    ...
    const service = new InstructorAdminService();
