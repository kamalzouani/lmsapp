...
type InstructorEditInstructorType = {
    visible: boolean,
    onClose: () => void,
    showToast: React.Ref<Toast>,
    selectedItem: InstructorDto
    update: (item: InstructorDto) => void,
    list: InstructorDto[],
    service: InstructorInstructorService,
    t: TFunction
}
const Edit: React.FC<InstructorEditInstructorType> = ({visible, onClose, showToast, selectedItem, update, list, service, t}) => {
    ...
    const {
        ...
        parseToIsoFormat,
        adaptDate
        } = useEditHook<InstructorDto, InstructorCriteria>({list, selectedItem, onClose, update, showToast,service, t, isFormValid})
                ...
                <div className="formgrid grid">
                    <div className="field col-6">
                        ...
                        <span className="p-float-label">
                            <InputTextarea id="bio" value={item ? item.bio : ''} onChange={(e) => onInputTextChange(e, 'bio')} rows={5} cols={30}/>
                        </span>
                    </div>
                    <div className="field col-6">
