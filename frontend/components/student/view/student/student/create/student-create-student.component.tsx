...
type StudentCreateStudentType = {
    visible: boolean,
    onClose: () => void,
    add: (item: StudentDto) => void,
    showToast: React.Ref<Toast>,
    list: StudentDto[],
    service: StudentStudentService,
    t: TFunction
}
const Create: React.FC<StudentCreateStudentType> = ({visible, onClose, add, showToast, list, service, t}) => {
    ...
    const emptyItem = new StudentDto();
        const {
            ...
            saveItem,
            formateDate
        } = useCreateHook<StudentDto, StudentCriteria>({list, emptyItem, onClose, add, showToast,service, isFormValid})
