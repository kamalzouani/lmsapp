...
import ma.zyn.app.service.facade.instructor.student.PaymentInstructorService;
...
import ma.zyn.app.service.facade.instructor.student.PaymentStateInstructorService ;
...
import java.util.List;
@Service
public class PaymentInstructorServiceImpl implements PaymentInstructorService {
    ...
    @Autowired
    private PaymentStateInstructorService paymentStateService ;
    @Autowired
    private StudentInstructorService studentService ;
    @Autowired
    private CourseInstructorService courseService ;

    public PaymentInstructorServiceImpl(PaymentDao dao) {
        this.dao = dao;
    }
