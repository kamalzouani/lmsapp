...
import ma.zyn.app.service.facade.instructor.course.ResourceInstructorService ;
...
public class LessonInstructorServiceImpl implements LessonInstructorService {
    ...
    @Autowired
    private ModuleInstructorService moduleService ;
    @Autowired
    private ResourceInstructorService resourceService ;

    public LessonInstructorServiceImpl(LessonDao dao) {
        this.dao = dao;
    }
