...
import ma.zyn.app.service.facade.instructor.course.ModuleInstructorService;
...
import ma.zyn.app.service.facade.instructor.course.LessonInstructorService ;
...
import java.util.List;
@Service
public class ModuleInstructorServiceImpl implements ModuleInstructorService {
    ...
    @Autowired
    private LessonInstructorService lessonService ;
    @Autowired
    private CurriculumInstructorService curriculumService ;

    public ModuleInstructorServiceImpl(ModuleDao dao) {
        this.dao = dao;
    }
