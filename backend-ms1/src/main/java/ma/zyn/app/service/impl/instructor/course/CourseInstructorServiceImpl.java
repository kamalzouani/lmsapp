...
import ma.zyn.app.service.facade.instructor.course.CategoryInstructorService ;
...
import ma.zyn.app.service.facade.instructor.course.CurriculumInstructorService ;
...
import ma.zyn.app.service.facade.instructor.course.LevelInstructorService ;
...
public class CourseInstructorServiceImpl implements CourseInstructorService {
    ...
    @Autowired
    private CategoryInstructorService categoryService ;
    @Autowired
    private InstructorInstructorService instructorService ;
    @Autowired
    private CurriculumInstructorService curriculumService ;
    @Autowired
    private LanguageInstructorService languageService ;
    @Autowired
    private LevelInstructorService levelService ;

    public CourseInstructorServiceImpl(CourseDao dao) {
        this.dao = dao;
    }
