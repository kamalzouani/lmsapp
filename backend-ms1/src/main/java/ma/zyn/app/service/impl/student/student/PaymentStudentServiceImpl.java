package ma.zyn.app.service.impl.student.student;
...
import ma.zyn.app.dao.specification.core.student.PaymentSpecification;
import ma.zyn.app.service.facade.student.student.PaymentStudentService;
...
import ma.zyn.app.service.facade.student.student.PaymentStateStudentService ;
import ma.zyn.app.bean.core.student.PaymentState ;
import ma.zyn.app.service.facade.student.student.StudentStudentService ;
...
import java.util.List;
@Service
public class PaymentStudentServiceImpl implements PaymentStudentService {
    ...
    public List<Payment> findByPaymentStateCode(String code){
        return dao.findByPaymentStateCode(code);
    }
    public List<Payment> findByPaymentStateId(Long id){
        return dao.findByPaymentStateId(id);
    }
    public int deleteByPaymentStateCode(String code){
        return dao.deleteByPaymentStateCode(code);
    }
    public int deleteByPaymentStateId(Long id){
        return dao.deleteByPaymentStateId(id);
    }
    public long countByPaymentStateCode(String code){
        return dao.countByPaymentStateCode(code);
    }
    @Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class, readOnly = false)
    ...
    @Autowired
    private PaymentStateStudentService paymentStateService ;
    @Autowired
    private StudentStudentService studentService ;
    @Autowired
    private CourseStudentService courseService ;

    public PaymentStudentServiceImpl(PaymentDao dao) {
        this.dao = dao;
    }
