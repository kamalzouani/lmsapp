...
import ma.zyn.app.service.facade.student.student.ReviewStudentService;
...
import java.util.List;
@Service
public class ReviewStudentServiceImpl implements ReviewStudentService {
    ...
    public ReviewStudentServiceImpl(ReviewDao dao) {
        this.dao = dao;
    }
