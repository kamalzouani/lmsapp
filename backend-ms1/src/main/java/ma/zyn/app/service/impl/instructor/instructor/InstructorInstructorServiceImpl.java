package ma.zyn.app.service.impl.instructor.instructor;
...
import java.util.List;
@Service
public class InstructorInstructorServiceImpl implements InstructorInstructorService {
    ...
    public InstructorInstructorServiceImpl(InstructorDao dao) {
        this.dao = dao;
    }
