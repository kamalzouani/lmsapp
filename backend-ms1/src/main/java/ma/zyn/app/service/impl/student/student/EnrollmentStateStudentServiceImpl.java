...
import java.util.List;
@Service
public class EnrollmentStateStudentServiceImpl implements EnrollmentStateStudentService {
    ...
    public EnrollmentStateStudentServiceImpl(EnrollmentStateDao dao) {
        this.dao = dao;
    }
