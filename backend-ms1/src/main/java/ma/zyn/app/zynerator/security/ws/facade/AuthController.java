...
public class AuthController {
    ...
    public ResponseEntity<Map<String, String>> registerStudent(@RequestBody UserDto userDto) {
        return register(userDto, AuthoritiesConstants.STUDENT);
    }
    @PostMapping("register/instructor")
    public ResponseEntity<Map<String, String>> registerInstructor(@RequestBody UserDto userDto) {
        return register(userDto, AuthoritiesConstants.INSTRUCTOR);
    }
