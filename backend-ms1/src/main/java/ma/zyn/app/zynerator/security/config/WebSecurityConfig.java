    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                                ...
                                .requestMatchers("/api/instructor/login").permitAll()
                                .requestMatchers("/api/admin/**").hasAnyAuthority(AuthoritiesConstants.ADMIN)
                                .requestMatchers("/api/student/**").hasAnyAuthority(AuthoritiesConstants.STUDENT)
                                .requestMatchers("/api/instructor/**").hasAnyAuthority(AuthoritiesConstants.INSTRUCTOR)
