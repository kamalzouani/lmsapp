package  ma.zyn.app.ws.facade.admin.instructor;
...
public class InstructorRestAdmin {
   ...
   public InstructorRestAdmin(InstructorAdminService service, InstructorConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final InstructorAdminService service;
