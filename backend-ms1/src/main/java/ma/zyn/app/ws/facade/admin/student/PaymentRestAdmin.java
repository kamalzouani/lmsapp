...
import ma.zyn.app.ws.converter.student.PaymentConverter;
...
public class PaymentRestAdmin {
    ...
    public List<PaymentDto> findByStudentId(@PathVariable Long id){
    ...
    public List<PaymentDto> findByCourseId(@PathVariable Long id){
    ...
    @Operation(summary = "find by paymentState code")
    @GetMapping("paymentState/code/{code}")
    public List<PaymentDto> findByPaymentStateCode(@PathVariable String code){
        return findDtos(service.findByPaymentStateCode(code));
    }
    @Operation(summary = "delete by paymentState code")
    @DeleteMapping("paymentState/code/{code}")
    public int deleteByPaymentStateCode(@PathVariable String code){
        return service.deleteByPaymentStateCode(code);
    }
