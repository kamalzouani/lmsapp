...
public class StudentRestStudent {
   ...
   public StudentRestStudent(StudentStudentService service, StudentConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final StudentStudentService service;
