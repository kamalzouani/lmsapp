function fn() {
    ...
    config.categoryUrl = config.adminUri + 'category/';
    config.reviewUrl = config.adminUri + 'review/';
    config.paymentStateUrl = config.adminUri + 'paymentState/';
    config.levelUrl = config.adminUri + 'level/';
    config.languageUrl = config.adminUri + 'language/';
    config.curriculumUrl = config.adminUri + 'curriculum/';
    config.studentUrl = config.adminUri + 'student/';
    config.enrollmentStateUrl = config.adminUri + 'enrollmentState/';
    config.enrollmentUrl = config.adminUri + 'enrollment/';
    config.lessonUrl = config.adminUri + 'lesson/';
    config.resourceUrl = config.adminUri + 'resource/';
    config.instructorUrl = config.adminUri + 'instructor/';
    config.moduleUrl = config.adminUri + 'module/';
    config.courseUrl = config.adminUri + 'course/';
