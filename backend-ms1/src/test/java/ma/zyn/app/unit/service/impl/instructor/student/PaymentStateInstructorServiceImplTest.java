...
import ma.zyn.app.service.impl.instructor.student.PaymentStateInstructorServiceImpl;
...
@SpringBootTest
class PaymentStateInstructorServiceImplTest {

    @Mock
    private PaymentStateDao repository;
    private AutoCloseable autoCloseable;
    private PaymentStateInstructorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new PaymentStateInstructorServiceImpl(repository);
    }
