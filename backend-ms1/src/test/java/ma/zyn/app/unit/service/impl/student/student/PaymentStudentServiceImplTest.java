...
import ma.zyn.app.service.impl.student.student.PaymentStudentServiceImpl;
...
@SpringBootTest
class PaymentStudentServiceImplTest {

    @Mock
    private PaymentDao repository;
    private AutoCloseable autoCloseable;
    private PaymentStudentServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new PaymentStudentServiceImpl(repository);
    }
