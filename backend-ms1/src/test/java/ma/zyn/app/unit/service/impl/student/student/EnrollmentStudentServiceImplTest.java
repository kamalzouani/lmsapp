...
import ma.zyn.app.service.impl.student.student.EnrollmentStudentServiceImpl;
...
@SpringBootTest
class EnrollmentStudentServiceImplTest {

    @Mock
    private EnrollmentDao repository;
    private AutoCloseable autoCloseable;
    private EnrollmentStudentServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new EnrollmentStudentServiceImpl(repository);
    }
	...
	private Enrollment constructSample(int i) {
        ...
        given.setEnrollmentState(new EnrollmentState(1L));
        return given;
    }
