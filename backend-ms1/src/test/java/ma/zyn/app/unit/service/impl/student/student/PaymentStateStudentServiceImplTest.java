...
import ma.zyn.app.service.impl.student.student.PaymentStateStudentServiceImpl;
...
@SpringBootTest
class PaymentStateStudentServiceImplTest {

    @Mock
    private PaymentStateDao repository;
    private AutoCloseable autoCloseable;
    private PaymentStateStudentServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new PaymentStateStudentServiceImpl(repository);
    }
