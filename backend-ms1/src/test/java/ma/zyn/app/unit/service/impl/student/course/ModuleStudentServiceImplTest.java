...
import ma.zyn.app.service.impl.student.course.ModuleStudentServiceImpl;
...
@SpringBootTest
class ModuleStudentServiceImplTest {

    @Mock
    private ModuleDao repository;
    private AutoCloseable autoCloseable;
    private ModuleStudentServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new ModuleStudentServiceImpl(repository);
    }
