package ma.zyn.app.unit.ws.facade.admin.instructor;
...
import ma.zyn.app.ws.facade.admin.instructor.InstructorRestAdmin;
...
public class InstructorRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private InstructorAdminServiceImpl service;
    @Mock
    private InstructorConverter converter;

    @InjectMocks
    private InstructorRestAdmin controller;
