package ma.zyn.app.unit.service.impl.student.instructor;

import ma.zyn.app.bean.core.instructor.Instructor;
import ma.zyn.app.dao.facade.core.instructor.InstructorDao;
import ma.zyn.app.service.impl.student.instructor.InstructorStudentServiceImpl;
...
class InstructorStudentServiceImplTest {
    ...
    void setUp() {
        ...
        underTest = new InstructorStudentServiceImpl(repository);
    }
