...
import ma.zyn.app.service.impl.instructor.course.LevelInstructorServiceImpl;
...
@SpringBootTest
class LevelInstructorServiceImplTest {

    @Mock
    private LevelDao repository;
    private AutoCloseable autoCloseable;
    private LevelInstructorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new LevelInstructorServiceImpl(repository);
    }
