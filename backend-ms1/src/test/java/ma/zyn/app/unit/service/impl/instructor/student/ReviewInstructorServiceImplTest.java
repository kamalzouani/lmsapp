...
import ma.zyn.app.service.impl.instructor.student.ReviewInstructorServiceImpl;
...
class ReviewInstructorServiceImplTest {
    ...
    private ReviewInstructorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new ReviewInstructorServiceImpl(repository);
    }
