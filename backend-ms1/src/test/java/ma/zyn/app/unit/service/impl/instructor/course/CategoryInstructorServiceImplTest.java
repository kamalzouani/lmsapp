...
import ma.zyn.app.service.impl.instructor.course.CategoryInstructorServiceImpl;
...
@SpringBootTest
class CategoryInstructorServiceImplTest {

    @Mock
    private CategoryDao repository;
    private AutoCloseable autoCloseable;
    private CategoryInstructorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new CategoryInstructorServiceImpl(repository);
    }
