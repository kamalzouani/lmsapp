...
import ma.zyn.app.service.impl.instructor.course.CurriculumInstructorServiceImpl;
...
@SpringBootTest
class CurriculumInstructorServiceImplTest {

    @Mock
    private CurriculumDao repository;
    private AutoCloseable autoCloseable;
    private CurriculumInstructorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new CurriculumInstructorServiceImpl(repository);
    }
