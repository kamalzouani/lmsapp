...
import ma.zyn.app.service.impl.admin.student.PaymentAdminServiceImpl;
import ma.zyn.app.ws.facade.admin.student.PaymentRestAdmin;
...
public class PaymentRestAdminTest {
    ...
    public void itShouldSavePaymentTest() throws Exception {
        ...
        assertEquals(savedDto.getPaymentDate(), responseBody.getPaymentDate());
    }
